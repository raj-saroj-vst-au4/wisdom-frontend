...
function AddStudentModal({showModal, toggleModal}) {
  ...
  const handleAddStudent = async () => {
    if(!name){
       return alert("Input the Name")
        ...
        const studentid = Math.floor(Math.random() * (999999 - 100000 + 1)) + 1000000;
        try {
        ...
        <div className="modal-content">
          ...
          <form>
            <div className="form-group row">
                ...
                <input type="text" className="form-control" id="inputName" placeholder="Students Full Name" onChange={(e)=> setName(e.target.value)}/>
                </div>
            </div>
            <br />
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                        <input type="number" className="form-control" id="inputNumber" placeholder="Parents Phone" onChange={(e)=> setNumber(e.target.value)}/>
                    </div>
                </div>
                <br />
                <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                        <select id="inputClass" className="form-control" defaultValue="null" onChange={(e)=> setStandard(e.target.value)}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                    <select id="inputBatch" className="form-control" defaultValue="null" onChange={(e)=> setBatch(e.target.value)}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                        <input type="number" className="form-control" id="inputFees" placeholder="Monthly Fees" onChange={(e)=> setFees(e.target.value)}/>
                    </div>
                </div>
